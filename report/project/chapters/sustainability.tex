...
The price of the consumed electricity during the development phase was $65$€ out of which only around half was paid out of the author's (my) pocket, as the other half was paid by my colleagues and their connections whom donated computational power during the feature selection, as well as the free service provides Google and Kaggle.\par
...
Approximately $500$ hours of man hours was spent on the development of this project. Adjusting the my last hourly wage as a mid-senior software engineer of $37$€ \citelink{salary}{in Denmark, to Spanish salaries} would yield an hourly wage of $21$€. Meaning the total charge would be $21$€ $ \cdot 500$h $ = 10500$€. Thus the billing for the project would be:
\begin{table}[H]
\centering
\begin{tabular}{|l|l|l|l|}
\hline
