...
\fancyhead{}
\fancyhead[R]{Brain Connectivity Mapping with Structural MRI}
\fancyfoot{}
\fancyfoot[R]{\thepage}
...
%pdf details
\hypersetup{
  pdftitle={Brain Connectivity Mapping with Structural MRI},
...
\title{Brain Connectivity Mapping with Structural MRI}
...
\input{chapters/fulfillment}
\chapter{Adjustments Made}
\input{chapters/adjustment}
